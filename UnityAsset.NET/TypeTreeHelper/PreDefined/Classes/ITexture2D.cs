...
{
    public Int32? m_ForcedFallbackFormat { get => null; }

    public bool? m_DownscaleFallback { get => null; }

    public bool? m_IsAlphaChannelOptional { get => null; }
    public Int32 m_Width { get; }
    public Int32 m_Height { get; }
    //public UInt32 m_CompleteImageSize { get; }
    public Int32? m_MipsStripped { get => null; }
    public Int32 m_TextureFormat { get; }
    public Int32 m_MipCount { get; }
    public bool m_IsReadable { get; }
    public bool? m_IsPreProcessed { get => null; }
    public bool? m_IgnoreMipmapLimit { get => null; }
    public string? m_MipmapLimitGroupName { get => null; }
    public bool? m_StreamingMipmaps { get => null; }
    public Int32? m_StreamingMipmapsPriority { get => null; }
    ...
    public List<byte>? m_PlatformBlob { get => null; }
